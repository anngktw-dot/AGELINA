...
I build backend APIs, AI-powered applications, and interactive product MVPs. My main focus is Python backend development, REST APIs, databases, automation, and practical AI integrations.

## Core Stack

**Backend:** Python, Django, Django REST Framework, FastAPI, Flask, Node.js, Express  
**Data:** PostgreSQL, SQL, Prisma, SQLAlchemy, SQLite  
**AI:** OpenAI-based workflows and practical AI integrations  

...
**Data:** PostgreSQL, SQL, Prisma, Pydantic  
...
A structured authentication frontend with login, registration, email verification, password recovery, typed validation, and automated quality checks.
...
The MVP includes connected screens, persisted demo state, vacancy filtering, candidate flow, editable interview responses, dynamic demo scoring, and billing interactions.
...
GitHub: [@anngktw-dot](https://github.com/anngktw-dot)
